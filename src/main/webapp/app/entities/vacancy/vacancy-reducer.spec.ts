...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vacancy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VACANCY_LIST actions', async () => {
    ...
    it('dispatches FETCH_VACANCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VACANCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VACANCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VACANCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VACANCY actions', async () => {
      const expectedActions = [
        {
