...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './schedule.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEDULE actions', async () => {
      const expectedActions = [
        {
