    ...
    <Row>
      <Col md="8">
        <h2 data-cy="scheduleDetailsHeading">
          <Translate contentKey="studentsPlatformApp.schedule.detail.title">Schedule</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="faculty">
              <Translate contentKey="studentsPlatformApp.schedule.faculty">Faculty</Translate>
            </span>
          </dt>
          <dd>{scheduleEntity.faculty}</dd>
          <dt>
            <span id="level">
              <Translate contentKey="studentsPlatformApp.schedule.level">Level</Translate>
            </span>
          </dt>
          <dd>{scheduleEntity.level}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="studentsPlatformApp.schedule.description">Description</Translate>
            </span>
          </dt>
