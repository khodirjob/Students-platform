...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './authors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTHORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUTHORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUTHORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUTHORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUTHORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUTHORS actions', async () => {
      const expectedActions = [
        {
