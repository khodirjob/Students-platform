...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cafe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAFE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAFE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAFE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAFE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAFE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAFE actions', async () => {
      const expectedActions = [
        {
