...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './apartment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APARTMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_APARTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APARTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APARTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APARTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APARTMENT actions', async () => {
      const expectedActions = [
        {
