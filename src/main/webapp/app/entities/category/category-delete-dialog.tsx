...
export const CategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="studentsPlatformApp.category.delete.question">
        <Translate contentKey="studentsPlatformApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
